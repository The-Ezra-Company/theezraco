  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-slate-600 text-center">
      ...
      <div className="relative z-10 flex h-screen flex-col items-center justify-center space-y-8 pt-16">
        <h1 className="roboto-bold-italic tracking-[-0.1em] text-white text-[144px] md:text-[192px] md:text-5xl">
          {COMPANY_NAME}
        </h1>
        <p className="lato-bold text-[32px] md:text-[64px] text-white leading-none">
          Launching
          Soon
        </p>

        <div className="absolute bottom-[64px] left-1/2 -translate-x-1/2 z-20 flex flex-col items-center">
          <FaAngleDoubleDown className="text-[48px] animate-pulse text-white" />
        </div>
      </div>
    </div>
  );
